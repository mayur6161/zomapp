                ...
                return(
                    <div key={item.menu_id}>
                        ...
                        <div className='col-md-4'>
                            <button className="btn btn-success" style={{height:"40px" , width:"40px" ,backgroundColor:"green"}}
                            onClick={()=>{this.placeOrder(item.menu_id)}}>
                                <span className='glyphicon glyphicon-plus'></span>
                            </button> &nbsp;
                            <button className="btn btn-danger" style={{height:"40px" , width:"40px" ,backgroundColor:"red"}}
